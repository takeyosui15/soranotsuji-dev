...
| `verify109.js` | 第25 | 本体地図MapLibre移行R1(フラグOFF=Leaflet不変[エンジン/アダプタ値/setView]・フラグON=?maplibre=1[本体+シャドウ+バッジ・ベース4種切替・ズーム換算±1・ズーム/パン/⌖/recenterのoffset向き・ダブルクリック地点移動・未移行マーカーはシャドウのみ・シャドウ視野追従]) |
...
- APP_VERSIONの版数ピンは**最新のverifyのみ**に置きます(第24ラウンド〜。旧verifyのピンを毎回更新する保守を廃止。現在のピンはverify109)
