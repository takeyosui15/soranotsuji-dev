...
check('N0 APP_VERSION 1.43.0', src.includes("APP_VERSION = '1.43.0'") || !!process.argv[2]);
check('N0 Version Historyに1.43.0の行がある', src.includes('Version 1.43.0 - ') || !!process.argv[2]);
