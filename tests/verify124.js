...
new Function('exports', src.slice(begin, end) +
  '\nexports.KEYS=_QP_KEYS_V12; exports.VALUES=_QP_VALUES_V12; exports.SEEDS12=_QP_SEEDS_V12; exports.SEEDS13=_QP_SEEDS_V13; exports.SEEDS14=_QP_SEEDS_V14; exports.SEEDS15=_QP_SEEDS_V15; exports.SEEDS16=_QP_SEEDS_V16; exports.SEEDS17=_QP_SEEDS_V17; exports.SEEDS18=_QP_SEEDS_V18;' +
...
const lintCoverage = (dictKeys) => [...EMIT].filter(k => !dictKeys.includes(k));
{
  ...
  const DICT_KEYS = qp.KEYS.concat(v14Keys, v15Keys, v16Keys, v17Keys, v18Keys);
  const missing = lintCoverage(DICT_KEYS);
  check('L2 URLビルダーが出力する全キーが辞書(v12キー+v14〜v18追加)にある(キー追加の入れ忘れ検知)',
    missing.length === 0, missing.length ? '辞書漏れ: ' + missing.join(', ') : `emit=${EMIT.size}keys v14=${v14Keys.length} v15=${v15Keys.length} v16=${v16Keys.length} v17=${v17Keys.length} v18=${v18Keys.length}`);
