...
// ---- V0: 版数ピン(最新の検証が持つ) ----
check('V0 版数(ピンはverify175へ移譲)+Version Historyに第148/第149', /APP_VERSION = '\d+\.\d+\.\d+'/.test(src) && ((src.includes('第148ラウンド — 可視マップ(段1') && src.includes('第149ラウンド — 可視マップ節の注記')) || !!process.argv[2]));
