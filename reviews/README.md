...
| `2026-07-19-round35-review.md` | 第35ラウンド(v1.37.0 スマホ辻メッシュ不具合3件+作法改善): 区分定数の非単調(3×3=6144px)がスマホ上限超え・表示状態の一方通行はテスト欠陥(手動再描画)が隠す・toDataURL→toBlob+revoke+世代ガード・非同期化後のテストは固定sleepでなくポーリング |
