...
- [x] 今回のデプロイで機能追加されたところをリストアップする。
  - 1. My天体改修、My観測点、My目的点、My辻検索、バックアップ/インポートの機能追加
- [x] 上記の機能は、組み込みの**ヘルプ**に内容が反映されているかを確認する。
  - [x] 1. My天体改修、My観測点、My目的点、My辻検索、バックアップ/インポートの機能追加
...
```bash
git add -A
git commit -m "deploy: soranotsuji-dev コミット 622a9c9 からデプロイ (v1.19.0)"
...
```
デプロイ日時: 2026-04-18 15:19
バージョン: v1.19.0
デプロイ元コミット: 622a9c9 (soranotsuji-dev)
デプロイ先コミット: bb3142e (soranotsuji)
確認結果: OK
```
