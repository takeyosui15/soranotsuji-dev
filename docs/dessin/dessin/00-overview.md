    ...
    - 動作
      - ①:ログインされているか、されていないかをチェックする。
        ...
        - ログイン状態をアイコンで表示する。
          ...
          - それ以外:🕛/⭕️/❌/😢/👎/👍
      - ②:soranotsuji_app.jsonの破損状態のチェック
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
## Myセットメニュー ( /docs/dessin/dessin/08-myset.md を参照のこと )
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
